...
export function getSettings(): BotSettings {
  ...
  return {
    ...
    monitor_model: (['a', 'b', 'alternate', 'ab', 'abc', 'd'].includes(map.monitor_model) ? map.monitor_model : 'a') as 'a' | 'b' | 'alternate' | 'ab' | 'abc' | 'd',
    monitor_d_sequential: (map.monitor_d_sequential ?? 'true') === 'true',
    monitor_d_retain_runs: parseInt(map.monitor_d_retain_runs || '200', 10),
    ...
    llm_monitor_c_endpoint: map.llm_monitor_c_endpoint || '',
    llm_monitor_c_max_tokens: parseInt(map.llm_monitor_c_max_tokens || '0', 10),
    ...
    llm_monitor_d_endpoint: map.llm_monitor_d_endpoint || '',
    llm_monitor_d_max_tokens: parseInt(map.llm_monitor_d_max_tokens || '0', 10),
    ...
    llm_stream_monitorA: map.llm_stream_monitorA !== 'false',
    llm_stream_monitorB: map.llm_stream_monitorB !== 'false',
    llm_stream_monitorC: map.llm_stream_monitorC !== 'false',
    ...
    llm_stream_monitorD: map.llm_stream_monitorD !== 'false',
    ...
    llm_monitor_c_fb_endpoint: map.llm_monitor_c_fb_endpoint || '',
    llm_monitor_c_fb_max_tokens: parseInt(map.llm_monitor_c_fb_max_tokens || '0', 10),
    ...
    telegram_notify_monitor_disagreement: (map.telegram_notify_monitor_disagreement ?? 'true') === 'true',
