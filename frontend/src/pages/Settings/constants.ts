...
export const SECTIONS = [
  ...
  { id: 'coach',      label: 'Coach Agent',       subtitle: 'Audit the agents and correct their memory',          icon: 'M22 10v6M2 10l10-5 10 5-10 5z M6 12v5c3 3 9 3 12 0v-5' },
...
export const LLM_MODULES: {
  ...
  { key: 'coach',               label: 'Coach Agent',          hint: 'The agentic, system-wide process auditor. Runs one global tool-calling pass that reviews the other agents and writes corrections into their memory, so use a tool-calling-capable model.', endpointKey: 'llm_coach_endpoint', maxTokensKey: 'llm_coach_max_tokens', fbEndpointKey: 'llm_coach_fb_endpoint', fbMaxTokensKey: 'llm_coach_fb_max_tokens', streamKey: 'llm_stream_coach' },
